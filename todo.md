...
- [ ] Endpoint quality rebuild: preserve 589×600 portal and 401×600 crystal source frames, display them at one-tile size with mipmapped linear filtering, verify native/Web sharpness, push master, and update the existing WebDev checkpoint.
