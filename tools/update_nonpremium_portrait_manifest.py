#!/usr/bin/env python3
"""Register generated non-premium portraits in assets/manifest.tres."""
...
LEGACY = {
    ...
    "portrait_caster_2": "res://assets/portraits/caster_2.png",
    "portrait_defender_1": "res://assets/portraits/defender_1.png",
    "portrait_defender_2": "res://assets/portraits/defender_2.png",
    "portrait_guard_1": "res://assets/portraits/guard_1.png",
    "portrait_guard_2": "res://assets/portraits/guard_2.png",
    "portrait_sniper_1": "res://assets/portraits/sniper_1.png",
    "portrait_sniper_2": "res://assets/portraits/sniper_2.png",
    "portrait_vanguard_1": "res://assets/portraits/vanguard_1.png",
    "portrait_vanguard_2": "res://assets/portraits/vanguard_2.png",
    "portrait_witch_doctor_1": "res://assets/portraits/witch_doctor_1.png",
}
...
def replace_or_insert(text: str, asset_id: str, path: str) -> str:
    ...
    anchor = '&"portrait_archive_caster": {'
