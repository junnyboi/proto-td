...
func _test_premium_identity_routing() -> void:
	...
	_check(
		ordinary_template in [&"sword_saint_female", &"sword_saint_male"],
		"ordinary guard_2 did not resolve to a generated Sword Saint variant",
	)
