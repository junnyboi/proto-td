...
func _run() -> void:
	...
	_check(PREFS.mark_field_team_tutorial_seen(PATH), "Field Team tutorial completion was not created")
	...
	_check(PREFS.mark_post_mission_tutorial_seen(PATH), "post-mission tutorial completion was not created")
...
func _verify_apply(game: Node, music: Node) -> void:
	...
	_check(PREFS.has_seen_field_team_tutorial(PATH), "batch save removed Field Team tutorial completion")
	_check(PREFS.has_seen_post_mission_tutorial(PATH), "batch save removed post-mission tutorial completion")
