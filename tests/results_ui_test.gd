...
func _run() -> void:
	...
	_check(transmission_body != null and transmission_body.text.contains("renewable stock") and transmission_body.text.contains("take Hearthcross residents"), "clear transmission body does not preserve the approved S1 people-taking reveal")
