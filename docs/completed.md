...
- TD-008 | AGENT A | Froze P16.0 deterministic hero identity/name, campaign save/hash/anchor, replay v1, recovery-roster, filesystem recovery, and adversarial proof contracts without exposing player-facing P16 behavior | implementation `cd35d19`; Audit 8 PASS | `docs/handoffs/TD-008-agent-a-p16-contracts.md`
