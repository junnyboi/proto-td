...
- TD-006 | AGENT 5 | Replaced the title's direct battle/Campaign split with one Start→campaign route, made Results campaign-only for players with a safe harness exit, and added non-vacuous fresh-session/reset proof | verified implementation `924f360` | `docs/handoffs/TD-006-agent-5-campaign-only-start.md`
