# TD-009 — Isometric Facing Arrows Handoff
...
- File ownership: changed `scripts/ui/deploy_bar.gd` and `selftest/scenarios/deploy_flow.gd`; closure records are `docs/todo.md`, `docs/completed.md`, and this handoff; all TD-009 reservations release after integration
...
- Docs: TD-009 moved from `docs/todo.md` to `docs/completed.md`; exactness plan is external at `facing-arrows-agent-2/TD-009-plan.md`; no decision or deviation required
- Risks: no machine blocker; the chooser intentionally draws above an active wave banner because an interactive placement ritual takes priority over a transient announcement
