...
- [x] **Phase 10 — Web local:** exact 202,817,120-byte runtime, eleven packs, six films, hashes/sizes, local HTTP/browser/network/console checks, and runtime-equivalent final source are recorded in `ANIMA_WAR_WEB_RELEASE.md`. Source release-record commit: pending this documentation commit.
