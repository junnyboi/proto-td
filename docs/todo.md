...
- Last release: 2026-08-12 — Poseidon reassigned AGENT 7 before presentation integration. `agent-7/polish-bolt` remains intentionally unmerged; it owns no active files or contracts and must not be merged wholesale by a successor.
- Last update: 2026-08-12
