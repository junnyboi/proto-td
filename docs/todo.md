...
- Owned files: `data/operators/witch_doctor_1.tres`, `assets/manifest.tres`, `assets/provenance/{witch_doctor_1,portrait_witch_doctor_1}.provenance.json`, `test/test_witch_doctor.gd`, `selftest/scenarios/{witch_doctor_heal,witch_doctor_ui_visuals}.gd`, `selftest/scenarios/witch_doctor_ui_visuals.gd.uid`, and TD-038 claim/closure edits in `docs/todo.md` / `docs/completed.md`
