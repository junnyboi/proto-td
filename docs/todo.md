...
- Owned files: `sim/{campaign_promotion,campaign_codec,campaign_hash,campaign_hero_codec,campaign_invariants,campaign_promotion_history,campaign_save_upgrade,campaign_migration,campaign_legacy_hash,hero_names}.gd`, `test/test_ui_registry_bootstrap.gd`, `docs/handoffs/TD-032-agent-8-sky-hunter-native-attacks.md`, and TD-032 claim/closure edits in `docs/todo.md` / `docs/completed.md`
