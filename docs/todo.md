...
## TD-031 — Replace Sky Hunter attack placeholders with native NE and NW

- Status: in_progress
- Owner: AGENT 8
- Branch: `agent-8/td-031-sky-hunter-native-attacks`
...
- Owned files: `assets/sprites/operators/animated/sniper_2/attack_*.png`, `assets/provenance/operators/{aetheria-part2-source-manifest,operator-animation-v1}.json`, all generated `assets/provenance/op_anim_*.provenance.json`, `assets/manifest.tres`, `data/presentation/operator_visuals/{caster_1,caster_2,defender_2,sniper_1,sniper_2}.tres`, `tools/art_pipeline/characters/{import_aetheria_part2_animations,validate_operator_animation_runtime}.py`, `tools/presentation_qa/{provenance.py,provenance_schema_v1.json}`, `test/{test_aetheria_part2_import,test_operator_animation_def,test_presentation_contracts}.gd`, `selftest/scenarios/operator_animation_part2.gd`, `docs/media/TD-031-SKY-HUNTER-NATIVE-APPROVAL.json`, `FEATURES.json`, `docs/handoffs/TD-031-agent-8-sky-hunter-native-attacks.md`, and TD-031 claim/closure edits in `docs/todo.md` / `docs/completed.md`
