...
- Status: pending
- Owner: unassigned
- Branch: N/A until claimed; AGENT 8 WIP is preserved on `agent-8/retire-movie-maker`
...
- Handoff: [`handoffs/VERIFY-MOVIE-agent-8.md`](handoffs/VERIFY-MOVIE-agent-8.md) records the released WIP and fresh green evidence
- Last update: 2026-08-12
