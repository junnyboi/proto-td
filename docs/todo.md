...
## TD-010 — Remove MapNavigator cold-cache parser dependency
...
- Owned files: `scripts/view/battle_view.gd`, `test/test_map_navigation.gd`, `docs/todo.md`, `docs/completed.md`, `docs/handoffs/TD-010-agent-9-mapnav-cold-cache-crash.md`
...
- Required evidence: real-context `battle_view.gd` preload regression, fresh import/boot, map-navigation scenario, and repository STANDARD-or-higher union gate
