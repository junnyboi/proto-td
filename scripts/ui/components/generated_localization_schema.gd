...
const PLACEHOLDER_TYPES := {
	...
	&"ui.squad.card_fallen": {&"class_name": &"String", &"level": &"int", &"name": &"String", &"rarity": &"int"},
	&"ui.squad.card_premium": {&"class_name": &"String", &"cost": &"int", &"level": &"int", &"life_unit": &"String", &"lives": &"int", &"name": &"String", &"rarity": &"int"},
	&"ui.squad.card_ready": {&"class_name": &"String", &"cost": &"int", &"level": &"int", &"name": &"String", &"rarity": &"int"},
	...
	&"ui.title.motion_short_state": {&"state": &"String"},
