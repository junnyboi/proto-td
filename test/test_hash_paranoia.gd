...
func test_every_hashed_field_group_flips_the_hash() -> void:
	...
	var cases: Dictionary = {
		...
		"unit.defense": func() -> void: m.units[0].defense += 1,
		"unit.resistance_permille": func() -> void: m.units[0].resistance_permille += 1,
		"unit.attack_damage_kind": func() -> void: m.units[0].attack_damage_kind += 1,
		...
		"enemy.defense": func() -> void: m.enemies[0].defense += 1,
		"enemy.resistance_permille": func() -> void: m.enemies[0].resistance_permille += 1,
		"enemy.attack_damage_kind": func() -> void: m.enemies[0].attack_damage_kind += 1,
		...
		"trap.damage_kind": func() -> void: m.traps[0].damage_kind += 1,
		...
		"spell.damage_kind": func() -> void: m.spell_book._damage_kinds[m.spell_book.ids[0]] += 1,
